...
public class AdminService : IAdminService
{
    ...
    private static string GetModuleDisplayName(string module) => module switch { "Dashboard" => "داشبورد", "Users" => "کاربران", "Roles" => "نقش‌ها", "Articles" => "مقالات", "Categories" => "دسته‌بندی‌ها", "Courses" => "دوره‌ها", "Quizzes" => "آزمون‌ها", "Challenges" => "چالش‌ها", "Announcements" => "اطلاعیه‌ها", "Reports" => "گزارش‌ها", "Settings" => "تنظیمات", "Glossary" => "واژه‌نامه", "Scoreboard" => "جدول امتیازات", "Feedback" => "بازخورد", "AIPolicy" => "خط مشی", "Management" => "مدیریت", _ => module };
